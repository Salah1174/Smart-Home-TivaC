...
/* Base address of UART5 registers */
#define UART5_BASE_ADDRESS 0x40011000

/* UART5 Registers */
#define UART5_DR_REG (*((volatile uint32 *)(UART5_BASE_ADDRESS + 0x000)))   // Data Register
#define UART5_FR_REG (*((volatile uint32 *)(UART5_BASE_ADDRESS + 0x018)))   // Flag Register
#define UART5_IBRD_REG (*((volatile uint32 *)(UART5_BASE_ADDRESS + 0x024))) // Integer Baud Rate Divisor
#define UART5_FBRD_REG (*((volatile uint32 *)(UART5_BASE_ADDRESS + 0x028))) // Fractional Baud Rate Divisor
#define UART5_LCRH_REG (*((volatile uint32 *)(UART5_BASE_ADDRESS + 0x02C))) // Line Control
#define UART5_CTL_REG (*((volatile uint32 *)(UART5_BASE_ADDRESS + 0x030)))  // Control Register
#define UART_LCRH_FEN_MASK 0x00000010                                       // FIFO Enable (bit 4 in UARTLCRH)
#define UART_FR_TXFF_MASK 0x00000020                                        // Transmit FIFO Full (bit 5 in UARTFR)
